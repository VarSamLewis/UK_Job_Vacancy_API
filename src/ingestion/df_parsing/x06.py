...
def _xlsx_sheets_to_csvs_x06(file_path: str, output_folder: str, header_row: int = None) -> None:
    """
    ...
    try:
        ...
        for sheet in sheet_names:
            ...
            df['Mon'] = pd.to_datetime(df['Mon'], errors='coerce').dt.strftime('%d/%m/%Y')
...
def main():
    ...
    output_path = Path(r"C:\Users\samle\Source\Repos\UK_Job_Vacancy_API\Data\x06")
    ...
    for file in files:
        ...
        _xlsx_sheets_to_csvs_x06(file_path, output_path, 3)
