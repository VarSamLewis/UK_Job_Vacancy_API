...
def _xlsx_sheets_to_csvs_vacs02(file_path: str, output_folder: str,header_row: int = None) -> None:
    """
    ...
    try:
        ...
        for sheet in sheet_names:
            ...
            df.drop(columns=['months', 'start_month_str', 'end_month_str', 'Quart', 'Unnamed: 1'], inplace=True)
...
def main():
    ...
    files = [f for f in os.listdir(folder) 
             ...
             and 'vacs02' in f.lower()
             ]

    for file in files:
        file_path = os.path.join(folder, file)
        _xlsx_sheets_to_csvs_vacs02(file_path, output_path, 3)
